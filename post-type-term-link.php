...
/* TEST */
function _test_register_post_types() {
	PostType_Term_Archive::get( 'post' , 'level' );
	PostType_Term_Archive::get( 'thing' , 'level' );
	...
	register_post_type( 'thing', $thing_args );
	...
	register_taxonomy( 'level' , array('thing','post') , $taxonomy_args );


}
add_action( 'init' , '_test_register_post_types' , 0 );
